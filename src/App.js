...
function App() {
  ...
  const api = (v) =>
    `https://api.openweathermap.org/data/2.5/weather?q=${v}&appid=925bd31878d68c71bdff1545b48ecd70&units=metric`;
  ...
  async function fetchResults() {
    ...
    try {
      const response = await fetch(
        `https://api.openweathermap.org/data/2.5/weather?lat=${deviceLocation[0]}&lon=${deviceLocation[1]}&appid=925bd31878d68c71bdff1545b48ecd70&units=metric`,
        myInit
      );
      if (!response.ok) {
